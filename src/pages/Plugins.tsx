...
import { removePlugin } from "@/lib/utils";
...
const Plugins = () => {
  ...
  const [plugins, setPlugins] = useState<Plugin[]>([
    {
      ...
      slug: "leads-avancado",
      version: "1.0.0",
      description: "Gestão avançada de leads com funil customizável.",
      author: "Equipe Garapa",
      homepage: "https://garapacrm.com/plugins/leads",
      category: "extension",
      tags: ["leads", "crm"],
      icon: "🔗",
      iconUrl: "",
    ...
    {
      id: 2,
      pluginId: "crm-whatsapp",
      name: "WhatsApp Business",
      slug: "whatsapp-business",
      version: "2.1.0",
      description: "Integração completa com WhatsApp Business.",
      author: "Equipe Garapa",
      homepage: "https://garapacrm.com/plugins/whatsapp",
      category: "integration",
      tags: ["whatsapp", "mensageria"],
      icon: "💬",
      iconUrl: "",
      minimumCoreVersion: "1.0.0",
      dependencies: [],
  ...
  const handleDelete = (id: number) => {
    if (window.confirm("Deseja realmente excluir este plugin?")) {
      setPlugins((prev) => removePlugin(prev, id));
    }
  };
